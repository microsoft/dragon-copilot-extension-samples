...
const defaultNonEmptyValidator: PromptValidator = value => {
  return value.trim() ? true : 'This field is required';
};

const defaultEmailValidator: PromptValidator = value => {
  if (!value.trim()) {
...
const defaultUrlValidator: PromptValidator = value => {
  if (!value.trim()) {
    return 'This field is required';
  }
...
const defaultVersionValidator: PromptValidator = value => {
  if (!value.trim()) {
