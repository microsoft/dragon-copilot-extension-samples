...
export function registerRadiologyCommands(program: Command): void {
    const radiology = program
        .command('radiology')
        .description('Commands for Dragon Copilot radiology extension projects');

    radiology
        .command('init')
        .description('Initialize a new radiology extension project')
    ...
    radiology
        .command('validate')
        .description('Validate a radiology extension manifest file')
    ...
    radiology
        .command('package')
        .description('Package a radiology extension into a distributable bundle')
