...
const cloneInstance = (): ConnectorIntegrationManifest['instance'] =>
...
const createBaseManifest = (overrides: Partial<ConnectorIntegrationManifest> = {}): ConnectorIntegrationManifest => {
  ...
  const manifest: ConnectorIntegrationManifest = {
    name: manifestName,
...
const ehrInstance: ConnectorIntegrationManifest['instance'] = {
  'client-authentication': {
    'allow-multiple-issuers': 'yes',
    issuer: {
      'access-token-issuer': {
...
const apiInstance: ConnectorIntegrationManifest['instance'] = {
  'client-authentication': {
    'allow-multiple-issuers': 'no',
    issuer: {
      'access-token-issuer': {
...
const dataSyncInstance: ConnectorIntegrationManifest['instance'] = {
  'client-authentication': {
    'allow-multiple-issuers': 'yes',
    issuer: {
      'access-token-issuer': {
...
const customInstance: ConnectorIntegrationManifest['instance'] = {
  'client-authentication': {
    'allow-multiple-issuers': 'no',
    issuer: {
      'access-token-issuer': {
