...
export function registerConnectorCommands(program: Command): void {
	const connector = program
		.command('connector')
		.description('Commands for Dragon Copilot Clinical Application Connector integrations');

	connector
		.command('init')
		.description('Initialize a new Clinical Application Connector project')
	...
	connector
		.command('generate')
		.description('Generate or update a Clinical Application Connector manifest')
	...
	connector
		.command('validate')
		.description('Validate a Clinical Application Connector manifest file')
	...
	connector
		.command('package')
		.description('Package a Clinical Application Connector into a distributable bundle')
