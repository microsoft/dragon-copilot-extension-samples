...
export function registerRadiologistsCommands(program: Command): void {
    const radiologists = program
        .command('radiologists')
        .description('Commands for Dragon Copilot (radiologists) extension projects');

    radiologists
        .command('init')
        .description('Initialize a new radiologists extension project')
    ...
    radiologists
        .command('generate')
        .description('Generate or update a radiologists extension manifest')
    ...
    radiologists
        .command('validate')
        .description('Validate a radiologists extension manifest file')
    ...
    radiologists
        .command('package')
        .description('Package a radiologists extension into a distributable bundle')
