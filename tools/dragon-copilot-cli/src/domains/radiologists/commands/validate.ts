...
export async function validateManifest(filePath: string): Promise<void> {
    console.log(chalk.blue('🐉 Validating Dragon Copilot Radiologists Extension Manifest'));
  ...
  try {
    ...
    const manifest = load(fileContent) as DcrExtensionManifest;
      ...
      console.log(chalk.blue('📋 Validating Radiologists Extension Manifest...'));
    ...
    if (!hasErrors) {
        ...
        console.log(chalk.gray('\n📊 Radiologists Extension Summary:'));
