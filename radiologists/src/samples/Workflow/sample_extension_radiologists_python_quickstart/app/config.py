...
class AuthenticationSettings(BaseModel):
    ...
    client_id: str = Field(
        default="<YOUR_APP_REGISTRATION_CLIENT_ID>", alias="ClientId"
    )
    instance: str = Field(
        default="https://login.microsoftonline.com/", alias="Instance"
    )
...
class Settings(BaseSettings):
    ...
    app_name: str = "Sample Radiologists Extension (Python)"
    version: str = "0.0.1"
