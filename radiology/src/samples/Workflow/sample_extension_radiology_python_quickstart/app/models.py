"""Pydantic mirrors of the C# Dragon.Copilot.Radiology.Models wire types.

Internal Python attributes use snake_case (idiomatic), while the JSON wire
contract uses the casing defined in radiology-extensibility-api.yaml. The
...
class Recommendation(_WireModel):
    ...
    additional_info: dict[str, str] | None = Field(
