...
using AuthOptions = SampleExtension.Radiology.Web.Quickstart.Configuration.AuthenticationOptions;

namespace SampleExtension.Radiology.Web.Quickstart.Extensions;
